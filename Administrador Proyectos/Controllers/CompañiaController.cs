...
namespace Administrador_Proyectos.Controllers
{
    public class CompañiaController : Controller
    {
        ...
        public CompañiaController(Administrador_ProyectosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,NIT,Direccion,CorreoElectronico")] Compañia compañia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,NIT,Direccion,CorreoElectronico")] Compañia compañia)
        {
            if (id != compañia.Id)
            {
                return NotFound();
        ...
        {
            return _context.Compañia.Any(e => e.Id == id);
        }
    }
}
